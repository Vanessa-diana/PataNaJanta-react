    ...
    <>
         ...
         <div class="row titulo">
            ...
            <br /> <h2>Adote um Pet</h2>
                ...
                <Cardpet titulo='Amigo não se compra' caminho={Amigo} descricao1='O Amigo não se Compra é um site em que ONGs e Protetores de todo o Brasil podem divulgar cães e gatos para adoção. O projeto existia informalmente desde 2012, mas em 2017 nos registramos oficialmente como uma Associação! '
                    descricao2='Clique abaixo para conhecer os cães e gatos que estão esperando um lar!' site='https://www.amigonaosecompra.com.br/' />
